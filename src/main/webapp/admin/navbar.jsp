...
<h3><i class="fa-solid fa-book"></i> BookWise</h3>
</div>


<div class="col-md-3">
<c:if test="${not empty userobj }">
<a class="btn customs "><i class="fas fa-user "></i> ${userobj.name} </a> 
<a data-toggle="modal" data-target="#exampleModalCenter" class="btn btnd text-white"><i class="fas fa-sign-in-alt"></i> LogOut</a>
</c:if>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <a href="../logout" type="button" class="btn btn-info text-white">LogOut</a>
        </div>
      </div>
